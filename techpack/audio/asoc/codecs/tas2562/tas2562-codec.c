...
static unsigned int p_tas2562_classH_D_data[] = {
	...
	TAS2562_ClassHHeadroom,
	0x4,
	0x09,
	0x99,
	0x99,
	0x9a,
	TAS2562_ClassHHysteresis,
	0x4,
	0x0,
	0x0,
	0x0,
	...
	0x1,
	0x38,
	TAS2562_ClassHReleaseTimer,
	0x1,
	0x3c,
	TAS2562_BoostSlope,
	0x1,
	0x78,
	TAS2562_TestPageConfiguration,
	0x1,
	0xd,
	TAS2562_ClassDConfiguration3,
	0x1,
	0x8e,
	TAS2562_ClassDConfiguration2,
	0x1,
	0x49,
	TAS2562_ClassDConfiguration4,
	0x1,
	0x21,
	TAS2562_ClassDConfiguration1,
	0x1,
	0x80,
...
static int tas2562_iv_enable(struct tas2562_priv *pTAS2562, int enable)
{
	...
	if (enable) {
		...
		nResult = pTAS2562->update_bits(
			pTAS2562, channel_both, TAS2562_PowerControl,
			 ...
			 struct snd_ctl_elem_value *ucontrol)
{
	...
	ret = pTAS2562->read(pTAS2562, channel_left, TAS2562_PowerControl,
			     &value);
	if (ret < 0)
...
static const struct snd_kcontrol_new tas2562_controls[] = {
	SOC_ENUM_EXT("TAS2562 IVSENSE ENABLE", tas2562_enum[0], tas2562iv_get,
		     tas2562iv_put),
};
		...
		if (nRegister == TAS2562_MSLEEP) {
			...
			if (nRegister != 0xFFFFFFFF) {
				...
				if (nSize > 1) {
					...
					nResult = pTAS2562->bulk_write(
						pTAS2562, chn, nRegister, Buf,
						nSize);
					if (nResult < 0)
						break;
				} else if (nSize == 1) {
				   ...
				   enum channel chn, int state)
{
	...
	case TAS2562_POWER_MUTE:
		nResult = pTAS2562->update_bits(
			pTAS2562, chn, TAS2562_PowerControl,
...
#ifdef CHANNEL_RIGHT
static int
tas2562_get_right_speaker_switch(struct snd_kcontrol *pKcontrol,
				 struct snd_ctl_elem_value *pUcontrol)
{
	struct snd_soc_codec *codec = snd_soc_kcontrol_codec(pKcontrol);
	struct tas2562_priv *pTAS2562 = snd_soc_codec_get_drvdata(codec);
...
static int
tas2562_set_right_speaker_switch(struct snd_kcontrol *pKcontrol,
				 struct snd_ctl_elem_value *pUcontrol)
{
	struct snd_soc_codec *codec = snd_soc_kcontrol_codec(pKcontrol);
	struct tas2562_priv *pTAS2562 = snd_soc_codec_get_drvdata(codec);
...
static int tas2562_mute(struct snd_soc_dai *dai, int mute)
{
	...
	if ((pTAS2562->spk_l_control == 1) && (pTAS2562->spk_r_control == 1) &&
	...
	if (mute) {
		tas2562_set_power_state(pTAS2562, channel_both,
...
static int tas2562_set_slot(struct tas2562_priv *pTAS2562, int slot_width)
{
	...
	switch (slot_width) {
	case 16:
		ret = pTAS2562->update_bits(
			pTAS2562, channel_both, TAS2562_TDMConfigurationReg2,
...
static int tas2562_set_samplerate(struct tas2562_priv *pTAS2562, int samplerate)
{
	...
	case 48000:
		pTAS2562->update_bits(
			pTAS2562, channel_both, TAS2562_TDMConfigurationReg0,
...
static int tas2562_set_fmt(struct tas2562_priv *pTAS2562, unsigned int fmt)
{
	...
	pTAS2562->update_bits(
		pTAS2562, channel_left, TAS2562_TDMConfigurationReg1,
	...
	if (pTAS2562->mnChannels == 2) {
		pTAS2562->update_bits(
			pTAS2562, channel_right, TAS2562_TDMConfigurationReg1,
			TAS2562_TDMConfigurationReg1_RXOFFSET51_Mask,
				    ...
				    int slots, int slot_width)
{
	...
	dev_dbg(pTAS2562->dev,
		"%s, tx_mask:%d, rx_mask:%d, slots:%d, slot_width:%d", __func__,
...
static int tas2562_load_init(struct tas2562_priv *pTAS2562)
{
	...
	/* Max voltage to 9V */
	ret = pTAS2562->update_bits(
		pTAS2562, channel_both, TAS2562_BoostConfiguration2,
		TAS2562_BoostConfiguration2_BoostMaxVoltage_Mask, 0x7);
	ret = pTAS2562->update_bits(
		pTAS2562, channel_both, TAS2562_PlaybackConfigurationReg0,
	...
	if (ret < 0)
		return ret;
	ret = tas2562_i2c_load_data(pTAS2562, channel_both,
...
static const struct snd_kcontrol_new tas2562_snd_controls[] = {
	SOC_SINGLE_TLV("Amp Output Level", TAS2562_PlaybackConfigurationReg0, 0,
		       0x16, 0, tas2562_digital_tlv),
...
int tas2562_register_codec(struct tas2562_priv *pTAS2562)
{
	...
	nResult =
		snd_soc_register_codec(pTAS2562->dev, &soc_codec_driver_tas2562,
				       tas2562_dai_driver,
...
void tas2562_LoadConfig(struct tas2562_priv *pTAS2562)
{
	...
	ret = tas2562_set_power_state(pTAS2562, channel_both,
				      pTAS2562->mnPowerState);
	if (ret < 0)
		goto end;
